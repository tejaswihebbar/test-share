...
/** Conformiq generated test case
	Accounts_Overview
*/
public class Accounts_Overview extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Accounts_Overview", "TC_Accounts_Overview", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Accounts_Overview","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Accounts_Overview","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Accounts_Overview","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Accounts_Overview","Step_5");
	...
	Reporter.log("Step - 7- click Account Overview hyperlink Account Services screen");

	testReport.fillTableStep("Step 7", "click Account Overview hyperlink Account Services screen");

	account_services_page_init.click_Account_Overview();
	getScreenshot(driver,Configurations.screenshotLocation , "Accounts_Overview","Step_7");

	Reporter.log("Step - 8- Verify Accounts Overview Action");

	testReport.fillTableStep("Step 8", "Verify Accounts Overview Action");

	accounts_overview_page_init.enter_Account(Step_8_Account_FIELD);

	accounts_overview_page_init.enter_Balance(Step_8_Balance_FIELD);

	accounts_overview_page_init.enter_Available_Amount(Step_8_Available_Amount_FIELD);
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Accounts_Overview");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
