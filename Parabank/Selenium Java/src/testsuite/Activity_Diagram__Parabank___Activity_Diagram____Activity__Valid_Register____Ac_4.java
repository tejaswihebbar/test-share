...
/** Conformiq generated test case
	Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4
*/
public class Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4 extends PageObjectBase
{

	public Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4", "TC_Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4","Step_6");

	Reporter.log("Step - 7- Verify Account Created Action");

	testReport.fillTableStep("Step 7", "Verify Account Created Action");

	account_created_page_init.enter_message(Step_7_message_FIELD);
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Activity_Diagram__Parabank___Activity_Diagram____Activity__Valid_Register____Ac_4");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
