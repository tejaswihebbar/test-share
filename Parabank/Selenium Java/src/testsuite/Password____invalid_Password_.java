...
/** Conformiq generated test case
	Password____invalid_Password_
*/
public class Password____invalid_Password_ extends PageObjectBase
{

	public Password____invalid_Password_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Password____invalid_Password_", "TC_Password____invalid_Password_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Password____invalid_Password_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Password____invalid_Password_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Password____invalid_Password_","Step_4");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Password____invalid_Password_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
