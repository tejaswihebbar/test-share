...
/** Conformiq generated test case
	Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5
*/
public class Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5 extends PageObjectBase
{

	public Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5", "TC_Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5","Step_6");

	Reporter.log("Step - 7- Verify Reject Register Action");

	testReport.fillTableStep("Step 7", "Verify Reject Register Action");

	reject_register_page_init.enter_First_Name(Step_7_First_Name_FIELD);

	reject_register_page_init.enter_Last_Name(Step_7_Last_Name_FIELD);

	reject_register_page_init.enter_Adress(Step_7_Adress_FIELD);

	reject_register_page_init.enter_City(Step_7_City_FIELD);

	reject_register_page_init.enter_State(Step_7_State_FIELD);

	reject_register_page_init.enter_Zip_Code(Step_7_Zip_Code_FIELD);

	reject_register_page_init.enter_Phone(Step_7_Phone_FIELD);

	reject_register_page_init.enter_SSN(Step_7_SSN_FIELD);

	reject_register_page_init.enter_UserName(Step_7_UserName_FIELD);

	reject_register_page_init.enter_Password(Step_7_Password_FIELD);

	reject_register_page_init.enter_Confirm(Step_7_Confirm_FIELD);
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Activity_Diagram__Parabank___Activity_Diagram____Activity__Invalid_Register_____5");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
