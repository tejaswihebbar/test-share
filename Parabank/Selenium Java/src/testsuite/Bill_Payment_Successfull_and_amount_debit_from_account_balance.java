...
/** Conformiq generated test case
	Bill_Payment_Successfull_and_amount_debit_from_account_balance
*/
public class Bill_Payment_Successfull_and_amount_debit_from_account_balance extends PageObjectBase
{

	public Bill_Payment_Successfull_and_amount_debit_from_account_balance()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Bill_Payment_Successfull_and_amount_debit_from_account_balance", "TC_Bill_Payment_Successfull_and_amount_debit_from_account_balance", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Bill_Payment_Successfull_and_amount_debit_from_account_balance","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Bill_Payment_Successfull_and_amount_debit_from_account_balance","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Bill_Payment_Successfull_and_amount_debit_from_account_balance","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Bill_Payment_Successfull_and_amount_debit_from_account_balance","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Bill_Payment_Successfull_and_amount_debit_from_account_balance","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Bill_Payment_Successfull_and_amount_debit_from_account_balance","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Bill_Payment_Successfull_and_amount_debit_from_account_balance","Step_9");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Bill_Payment_Successfull_and_amount_debit_from_account_balance");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
