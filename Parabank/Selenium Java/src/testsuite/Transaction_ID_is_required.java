...
*/
public class Transaction_ID_is_required extends PageObjectBase
{

	public Transaction_ID_is_required()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Transaction_ID_is_required", "TC_Transaction_ID_is_required", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Transaction_ID_is_required","Step_11");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Transaction_ID_is_required");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
