...
/** Conformiq generated test case
	All_Fileds_are_required_and_should_not_be_empty
*/
public class All_Fileds_are_required_and_should_not_be_empty extends PageObjectBase
{

	public All_Fileds_are_required_and_should_not_be_empty()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "All_Fileds_are_required_and_should_not_be_empty", "TC_All_Fileds_are_required_and_should_not_be_empty", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "All_Fileds_are_required_and_should_not_be_empty","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "All_Fileds_are_required_and_should_not_be_empty","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "All_Fileds_are_required_and_should_not_be_empty","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "All_Fileds_are_required_and_should_not_be_empty","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "All_Fileds_are_required_and_should_not_be_empty","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "All_Fileds_are_required_and_should_not_be_empty","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "All_Fileds_are_required_and_should_not_be_empty","Step_9");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "All_Fileds_are_required_and_should_not_be_empty");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
