...
/** Conformiq generated test case
	Node_Activity__Request_Loan_
*/
public class Node_Activity__Request_Loan_ extends PageObjectBase
{

	public Node_Activity__Request_Loan_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__Request_Loan_", "TC_Node_Activity__Request_Loan_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_5");
	...
	Reporter.log("Step - 7- click Request Loan hyperlink Account Services screen");

	testReport.fillTableStep("Step 7", "click Request Loan hyperlink Account Services screen");

	account_services_page_init.click_Request_Loan();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_7");

	Reporter.log("Step - 8- verify Apply for a Loan screen");

	testReport.fillTableStep("Step 8", "verify Apply for a Loan screen");

	apply_for_a_loan_page_init.verify_Loan_Amount_Status(Step_8_Loan_Amount_TEXTBOX_Status);

	apply_for_a_loan_page_init.verify_Loan_Amount(Step_8_Loan_Amount_TEXTBOX_Verification);
	apply_for_a_loan_page_init.verify_Down_Payment_Status(Step_8_Down_Payment_TEXTBOX_Status);

	apply_for_a_loan_page_init.verify_Down_Payment(Step_8_Down_Payment_TEXTBOX_Verification);
	apply_for_a_loan_page_init.verify_From_Account_Status(Step_8_From_Account_DROPDOWN_Status);

	apply_for_a_loan_page_init.verify_From_Account(Step_8_From_Account_DROPDOWN_Verification);
	apply_for_a_loan_page_init.verify_Apply_Now_Status(Step_8_Apply_Now_BUTTON_Status);

	apply_for_a_loan_page_init.verify_Account_Overview_Status(Step_8_Account_Overview_HYPERLINK_Status);

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_8");

	Reporter.log("Step - 9- Fill Loan form Apply for a Loan screen");

	testReport.fillTableStep("Step 9", "Fill Loan form Apply for a Loan screen");

	apply_for_a_loan_page_init.set_Loan_Amount(Step_9_Loan_Amount_TEXTBOX);
	apply_for_a_loan_page_init.set_Down_Payment(Step_9_Down_Payment_TEXTBOX);
	apply_for_a_loan_page_init.select_From_Account(Step_9_From_Account_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_9");

	Reporter.log("Step - 10- click Apply Now button Apply for a Loan screen");

	testReport.fillTableStep("Step 10", "click Apply Now button Apply for a Loan screen");

	apply_for_a_loan_page_init.click_Apply_Now();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_10");

	Reporter.log("Step - 11- Verify Loan Request Processed Action");

	testReport.fillTableStep("Step 11", "Verify Loan Request Processed Action");

	loan_request_processed_page_init.enter_Loan_Provider(Step_11_Loan_Provider_FIELD);

	loan_request_processed_page_init.enter_Date(Step_11_Date_FIELD);

	loan_request_processed_page_init.enter_Status(Step_11_Status_FIELD);

	loan_request_processed_page_init.enter_message(Step_11_message_FIELD);

	loan_request_processed_page_init.enter_Account_Number(Step_11_Account_Number_FIELD);


	Reporter.log("Step - 12- click Account Overview hyperlink Apply for a Loan screen");

	testReport.fillTableStep("Step 12", "click Account Overview hyperlink Apply for a Loan screen");

	apply_for_a_loan_page_init.click_Account_Overview();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__Request_Loan_","Step_12");

	Reporter.log("Step - 13- Verify Account Overviews for Loan Action");

	testReport.fillTableStep("Step 13", "Verify Account Overviews for Loan Action");

	account_overviews_for_loan_page_init.enter_Account1(Step_13_Account1_FIELD);

	account_overviews_for_loan_page_init.enter_Balance_of_Account1(Step_13_Balance_of_Account1_FIELD);

	account_overviews_for_loan_page_init.enter_Available_Amount_of_Account_1(Step_13_Available_Amount_of_Account_1_FIELD);

	account_overviews_for_loan_page_init.enter_Account2(Step_13_Account2_FIELD);

	account_overviews_for_loan_page_init.enter_Balance_Account2(Step_13_Balance_Account2_FIELD);

	account_overviews_for_loan_page_init.enter_Avilable_Amount_of_Account2(Step_13_Avilable_Amount_of_Account2_FIELD);

	account_overviews_for_loan_page_init.enter_Total_Amount(Step_13_Total_Amount_FIELD);

	}
	@DataProvider(name = "TestData")
	public Object[][] getData() {
	return DataUtil.getDataFromSpreadSheet("TestData.xlsx", "TCID_20");
}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__Request_Loan_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
