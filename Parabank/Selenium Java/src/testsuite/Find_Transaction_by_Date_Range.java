...
*/
public class Find_Transaction_by_Date_Range extends PageObjectBase
{

	public Find_Transaction_by_Date_Range()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Find_Transaction_by_Date_Range", "TC_Find_Transaction_by_Date_Range", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_9");

	Reporter.log("Step - 10- Fill Date Range form Find Transactions screen");

	testReport.fillTableStep("Step 10", "Fill Date Range form Find Transactions screen");

	find_transactions_page_init.set_Between(Step_10_Between_TEXTBOX);
	find_transactions_page_init.set_And(Step_10_And_TEXTBOX);
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_10");

	Reporter.log("Step - 11- click Find Transactions button Find Transactions screen Date Range form");

	testReport.fillTableStep("Step 11", "click Find Transactions button Find Transactions screen Date Range form");

	find_transactions_page_init.click_Find_Transactions();
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_11");

	Reporter.log("Step - 12- verify Transaction Result screen");

	testReport.fillTableStep("Step 12", "verify Transaction Result screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Date_Range","Step_12");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Find_Transaction_by_Date_Range");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
