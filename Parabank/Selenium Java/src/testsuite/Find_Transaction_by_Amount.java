...
*/
public class Find_Transaction_by_Amount extends PageObjectBase
{

	public Find_Transaction_by_Amount()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Find_Transaction_by_Amount", "TC_Find_Transaction_by_Amount", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_9");

	Reporter.log("Step - 10- Fill Find By Amount form Find Transactions screen");

	testReport.fillTableStep("Step 10", "Fill Find By Amount form Find Transactions screen");

	find_transactions_page_init.set_Find_By_Amount(Step_10_Find_By_Amount_TEXTBOX);
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_10");

	Reporter.log("Step - 11- click Find Transactions button Find Transactions screen Find By Amount form");

	testReport.fillTableStep("Step 11", "click Find Transactions button Find Transactions screen Find By Amount form");

	find_transactions_page_init.click_Find_Transactions();
	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_11");

	Reporter.log("Step - 12- verify Transaction Result screen");

	testReport.fillTableStep("Step 12", "verify Transaction Result screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Find_Transaction_by_Amount","Step_12");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Find_Transaction_by_Amount");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
