...
/** Conformiq generated test case
	From_date_and_To_date_are_required
*/
public class From_date_and_To_date_are_required extends PageObjectBase
{

	public From_date_and_To_date_are_required()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "From_date_and_To_date_are_required", "TC_From_date_and_To_date_are_required", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "From_date_and_To_date_are_required","Step_11");
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "From_date_and_To_date_are_required");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
