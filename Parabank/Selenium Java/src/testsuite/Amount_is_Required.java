...
/** Conformiq generated test case
	Amount_is_Required
*/
public class Amount_is_Required extends PageObjectBase
{

	public Amount_is_Required()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Amount_is_Required", "TC_Amount_is_Required", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Amount_is_Required","Step_11");
	...
	return DataUtil.getDataFromSpreadSheet("TestData.xlsx", "TCID_18");
}
	@AfterTest
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Amount_is_Required");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
